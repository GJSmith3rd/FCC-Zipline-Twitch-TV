    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.status !== 422) {
          ...
          var logo = data.logo !== null ? data.logo : 'http://res.cloudinary.com/mobilecreature/image/upload/f_auto,fl_lossy,dpr_auto,q_80,w_35,h_35/v1456543488/FreeCodeCamp/Ziplines/Twitch-TV/5Ia41S4.png';
          ...
          $('<li class="clearfix list-group-item">' +
            ...
            '<img width="35" height="35" src="' +
            'http://res.cloudinary.com/mobilecreature/image/upload/f_auto,fl_lossy,dpr_auto,q_80,w_35,h_35/v1456607682/FreeCodeCamp/Ziplines/Twitch-TV/images.jpg' +
            '" />' +
